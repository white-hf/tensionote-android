...
fun DetailedRecordScreen(
    ...
    Column(
        ...
        Text(stringResource(R.string.home_detailed_entry_button), style = MaterialTheme.typography.headlineMedium)
        OutlinedTextField(
            value = systolic,
            onValueChange = {
                systolic = it
        ...
        Text(stringResource(R.string.record_tags_section), style = MaterialTheme.typography.titleMedium)
        ...
        Button(
            onClick = {
                ...
                if (systolicValue != null && diastolicValue != null && heartRateValue != null) {
                    ...
                    AppGraph.bloodPressureRepository.saveDetailedRecord(
